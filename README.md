...
<details>
    ...
    <p> This folder contains programs that can be used by the users to set up or extract data. <code>plot_csv.py</code> plots a couple of measurements. <br>
        ...
        The <code>liv_edata.py</code> enables users to make a plot of the most recent incoming datapoint for their PV module and check whether it is what they expect.
    </p>
</details>
